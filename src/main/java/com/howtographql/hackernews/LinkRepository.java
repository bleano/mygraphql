...
public class LinkRepository {
    ...
    public List<Link> getAllLinks(final Integer min, final Integer max, String domain) throws Exception{
        ...
        if(allLinks.size() < min) throw new Exception("min size not fulfilled");
